 ...
 */
public class AutoRespondingProcessIoHandler implements ProcessIoHandler {
    ...
    public static class Factory implements ProcessIoHandler.Factory {
        ...
        public ProcessIoHandler createHandler(Process process) {
            ...
            return new AutoRespondingProcessIoHandler(
                    mPattern, mResponse,
    ...
    public AutoRespondingProcessIoHandler(
    ...
    private synchronized void checkIfFirstTimeOrThrow() {
        if (mAlreadyStarted) {
            throw new RuntimeException("`run` method already called");
        }
